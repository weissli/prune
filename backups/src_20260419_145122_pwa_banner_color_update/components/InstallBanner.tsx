...
export const InstallBanner: React.FC<InstallBannerProps> = ({
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[100] p-5 bg-gradient-to-r from-brand-600 to-brand-700 shadow-2xl text-white">
      ...
      {!isIOS && hasPrompt && (
        <div className="mt-4 flex justify-end">
          <Button 
            onClick={onInstall} 
            className="bg-white text-brand-600 hover:bg-brand-50 border-none font-medium"
          >
            Install Now
          </Button>
        </div>
